\chapter{Modo plasmónico guiado}
...
El sistema blah, blah. Ejemplo de cita \cite{texbook}
...
\section{\textcolor{UNAMblue}{CSM vs. Experimento}}
...
\begin{table}[htp]                             %Inicia el entorno table debajo del texto
