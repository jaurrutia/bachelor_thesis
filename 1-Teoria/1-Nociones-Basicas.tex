...
En la Fig. \ref{fig:coefAmp}, el coeficiente de amplitud de reflexión $r_p$ [Ec. \eqref{eq:rp}] es igual a cero para el ángulo Brewster $\theta_B$, dado por \cite{hecht1998optics}\index{Ángulo!de Brewster} \index{Brewster!ángulo de}
%
	\begin{align}
