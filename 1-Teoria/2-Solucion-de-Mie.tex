...
Para resolver la Ec. \eqref{eq:AEV_psi} se emplea el método de separación de variables, proponiendo como solución $\psi= R(r)\Theta(\theta) \Phi(\varphi)$. Para que $\psi$ sea solución a la Ec.  \eqref{eq:AEV_psi}, las funciones $R(r),\, \Theta(\theta), \mbox{ y } \Phi(\varphi)$ deben cumplir las siguientes ecuaciones diferenciales
	\begin{align}
...
%
Los armónicos esféricos vectoriales son solución a la ecuación de Helmholtz, por lo que cualquier solución de los campos EMs transversales puede escribirse como una serie infinta en términos de las Ecs. \eqref{eq:AEV}. 
