...
\begin{figure}[h!]\centering
\begin{tikzpicture}
\node[inner sep=0pt] (graf) at (.05,0){\includegraphics[width =.705\linewidth]{2-Resultados/figs/11-SPPCSM/3-2D_Grid.png}};
